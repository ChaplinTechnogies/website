...
// Icons (Replace with a proper icon library like lucide-react or react-icons in production)
const EyeIcon = () => (
...
export default function AdminLogin() {
  ...
  const [rememberMe, setRememberMe] = useState(false); // Added for the design
  const [showPassword, setShowPassword] = useState(false); // Added for the design
  ...
  return (
    // Main container with a split screen layout, ensuring full height
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  // The placeholder is set to match the design's input state
                  placeholder="@##*%" 
                  required
